...
export default function ProjectsGrid() {
  ...
  const projects: ProjectItem[] = [
    ...
    },
    {
      ...
      subtitle: "Next-Gen Telemetry & Security Ops Platform",
      description: "Advanced security telemetry, live audit operations, and real-time monitoring platform featuring a Python control core, glassmorphism web panel, HMAC-SHA256 JWT security, and multi-channel webhooks (Telegram, Discord, Slack).",
      tags: ["Python3", "PHP8", "Chart.js", "JWT HMAC", "Webhooks"],
      category: "security",
